...
ln -s /home/cpwells@colostate.edu/scratch/chinook-play/chinook-genome-idx genome
...
# Here is what I did (making a symbolic link)
ln -s  /home/cpwells@colostate.edu/scratch/fastqs-chr32-160-chinook-8-lanes fastqs
